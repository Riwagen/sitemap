defmodule Sitemap.Config do
  ...
  def configure(overwrite) do
    ...
    start_link(%__MODULE__{
      ...
      files_path:           nil_or([ow[:files_path]          , getenv("SITEMAP_SITEMAPS_PATH"), Application.get_env(:sitemap, :files_path,          "sitemapss/")]),
      public_path:          nil_or([ow[:public_path]         , getenv("SITEMAP_PUBLIC_PATH")  , Application.get_env(:sitemap, :public_path,         "sitemapssss/")]),
